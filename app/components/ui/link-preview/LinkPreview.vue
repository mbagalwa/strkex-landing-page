<template>
  <div :class="cn('relative inline-block', props.class)">
    <!-- Trigger -->
    <NuxtLink :to="url" target="_blank" :class="cn('text-black dark:text-white', props.linkClass)"
      @mousemove="handleMouseMove" @mouseenter="showPreview" @mouseleave="hidePreview">
      <slot />
    </NuxtLink>
