                              ...
                              <div
                                    ...
                                    <div
                                          ...
                                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                strokeWidth="1.5" stroke="currentColor" class="size-2 text-gray-300">
                                    ...
                                    <p class="relative z-50 mb-4 text-base font-normal text-slate-500">
                                          ...
                                          One more
                                          sentence because lorem ipsum is just unacceptable. Won&apos;t ChatGPT the shit
                                          out of
                                          this.
                                    </p>

                                    <button
                                          class="rounded-lg border border-gray-500 px-4 py-1 text-gray-300">Explore</button>
                                    <Meteors />
                              </div>
                        </div>
                  </div>
